...
class HomeFragment : Fragment(), View.OnClickListener, getSong, ILongClickPlaylist {
    ...
    val intent = Intent()
    private val liveData = MutableLiveData<MutableList<Song>>()
...
//            ViewModelProvider(this).get(OnlViewModel::class.java)
        ...
        playList = playlistManager.getAllPlaylist()
        listName = playlistManager.getAllNamePlaylist()
...
//        when (item.itemId){
//            R.id.sort_a -> {
//                Log.d("eee",item.itemId.toString())
//                MediaManager.sort =1
